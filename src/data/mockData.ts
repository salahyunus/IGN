...
export const mockSubjects: Subject[] = [
  {
    ...
    syllabus: {
      introduction:
        "This course covers advanced mathematical concepts including calculus, linear algebra, and statistics.",
      image:
        "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800&h=400&fit=crop",
      links: [
        { title: "Course Syllabus PDF", url: "#" },
        { title: "Important Files", url: "#" },
      ],
    },
  },
  {
    ...
    icon: "🧪",
    color: "#7b87f9",
    description: "Advanced Chemical concepts and reaction solving",
    totalChapters: 0,
    progress: 0,
    estimatedHours: 0,
    syllabus: {
      introduction:
        "This course covers advanced chemical concepts including chemistry, balancing equations, and statistics.",
      image:
        "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800&h=400&fit=crop",
      links: [
        { title: "Course Syllabus PDF", url: "#" },
  ...
  //   color: "#3bf6ae",
  //   description:
  //     "Covers fundamental biological principles including classification, cell structure, transport, reproduction, and ecology for the IGCSE syllabus.",
  //   totalChapters: 3,
  //   progress: 0, // update dynamically
  //   estimatedHours: 40,
  //   syllabus: {
  //     introduction:
  //       "This course provides a comprehensive overview of biological systems, focusing on key topics like cell biology, classification, nutrition, transport, and DNA technologies aligned with IGCSE Biology 0970/0610.",
  //     image:
  //       "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800&h=400&fit=crop",
  //     links: [
  //       { title: "IGCSE Biology Syllabus PDF", url: "#" },
  //       { title: "Cambridge Biology Resources", url: "#" },
  //     ],
  //   },
  // },
];
