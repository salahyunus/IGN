      ...
      >
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold mb-4">
            IGCSE <span className="text-[hsl(var(--primary))]">Notes</span>
          </h1>
          <p className="text-muted-foreground text-lg">
            Best Smart IGCSE Notes | Unlimited features.
          </p>
        </div>
        ...
        >
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-6 leading-relaxed">
              Hey! I'm an IGCSE student who built this website from scratch to
              help others like you and me — completely free and without any ads.
              I've put in A LOT of time and effort, and donations really help me
              keep it running, add more features, and continue offering it free
              to everyone in the future. Good luck studying — and thank you so
